...
const members: Member[] = [
  { name: 'Raviraj Sarvade', role: 'President', imageUrl: '/images/commitie/raviraj-sarvade.jpeg' },
  { name: 'Sumit Talwade', role: 'Vice President', imageUrl: '/images/commitie/sumit-talwade.jpeg' },
  { name: 'Shubham Pote', role: 'Secretary', imageUrl: '/images/commitie/shubham-pote.jpeg' },
  { name: 'Yuraj Gaikwad', role: 'Secretary', imageUrl: '/images/commitie/yuraj-gaikwad.jpeg' },
  { name: 'Tanish Sidam', role: 'Treasurer', imageUrl: '/images/commitie/tanish-sidam.jpeg' },
  { name: 'Ganesh Ingole', role: 'Treasurer', imageUrl: '/images/commitie/ganesh-ingole.jpeg' },
  { name: 'Mithun Ganachari', role: 'Joint Secretary', imageUrl: '/images/commitie/mithun-ganachari.jpeg' },
  { name: 'Yash Bhalerao', role: 'Advisor', imageUrl: '/images/commitie/yash-bhalerao.jpeg' },
  { name: 'Adesh Jawale', role: 'Advisor', imageUrl: '/images/commitie/adesh-jawale.jpeg' },
  { name: 'Yash Sawarkar', role: 'Cultural Committee Head', imageUrl: '/images/commitie/yash-sawarkar.jpeg' },
  { name: 'Suraj Tayde', role: 'Social Media Head', imageUrl: '/images/commitie/suraj-tayde.jpg' },
  { name: 'Onkar Satpute', role: 'Technical Team', imageUrl: '/images/commitie/onkar-satpute.jpeg' },
  // { name: 'Shrinivas Kumari', role: 'Technical Team', imageUrl: '/images/commitie/shrinivas-kumari.jpg' },
